 ...
 *  @generated
 */
@javax.annotation.Generated(value = "Autogenerated by Thrift Compiler (0.20.0)", date = "2024-05-19")
...
public class m2r {
  ...
  public interface Iface {
    ...
    public void create(String table, String sql, java.util.List<String> slave_addrs) throws org.apache.thrift.TException;

    public void drop(String table) throws org.apache.thrift.TException;

    public void recover(String table, String region_addr) throws org.apache.thrift.TException;

    public void upgrade(String table, java.util.List<String> slave_addrs) throws org.apache.thrift.TException;

  }

  public interface AsyncIface {

    public void create(String table, String sql, java.util.List<String> slave_addrs, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws org.apache.thrift.TException;

    public void drop(String table, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws org.apache.thrift.TException;

    public void recover(String table, String region_addr, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws org.apache.thrift.TException;

    public void upgrade(String table, java.util.List<String> slave_addrs, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_create(String table, String sql, java.util.List<String> slave_addrs) throws org.apache.thrift.TException
    {
    ...
    public void recover(String table, String region_addr) throws org.apache.thrift.TException
    {
      send_recover(table, region_addr);
    }

    public void send_recover(String table, String region_addr) throws org.apache.thrift.TException
    {
      recover_args args = new recover_args();
      args.setTable(table);
      args.setRegion_addr(region_addr);
    ...
    public void send_upgrade(String table, java.util.List<String> slave_addrs) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class create_call extends org.apache.thrift.async.TAsyncMethodCall<Void> {
      ...
      public create_call(String table, String sql, java.util.List<String> slave_addrs, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
    ...
    public static class drop_call extends org.apache.thrift.async.TAsyncMethodCall<Void> {
      private String table;
      public drop_call(String table, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, true);
        this.table = table;
      }
    ...
    public void recover(String table, String region_addr, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      recover_call method_call = new recover_call(table, region_addr, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public static class upgrade_call extends org.apache.thrift.async.TAsyncMethodCall<Void> {
      private String table;
      private java.util.List<String> slave_addrs;
      public upgrade_call(String table, java.util.List<String> slave_addrs, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, true);
        this.table = table;
        this.slave_addrs = slave_addrs;
      }
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class recover<I extends Iface> extends org.apache.thrift.ProcessFunction<I, recover_args> {
      ...
      public org.apache.thrift.TBase getResult(I iface, recover_args args) throws org.apache.thrift.TException {
        iface.recover(args.table, args.region_addr);
        return null;
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class recover<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, recover_args, Void> {
      ...
      public void start(I iface, recover_args args, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws org.apache.thrift.TException {
        iface.recover(args.table, args.region_addr,resultHandler);
      }
    }
  ...
  public static class create_args implements org.apache.thrift.TBase<create_args, create_args._Fields>, java.io.Serializable, Cloneable, Comparable<create_args>   {
    ...
    public create_args setSlave_addrs(@org.apache.thrift.annotation.Nullable java.util.List<String> slave_addrs) {
      this.slave_addrs = slave_addrs;
      return this;
    }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.slave_addrs = new java.util.ArrayList<String>(_list0.size);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, create_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.slave_addrs != null) {
          oprot.writeFieldBegin(SLAVE_ADDRS_FIELD_DESC);
          {
            ...
            for (String _iter3 : struct.slave_addrs)
            {
        ...
        if (struct.isSetSlave_addrs()) {
          {
            ...
            for (String _iter4 : struct.slave_addrs)
            {
        ...
        if (incoming.get(2)) {
          {
            ...
            struct.slave_addrs = new java.util.ArrayList<String>(_list5.size);
  ...
  public static class recover_args implements org.apache.thrift.TBase<recover_args, recover_args._Fields>, java.io.Serializable, Cloneable, Comparable<recover_args>   {
    ...
    private static final org.apache.thrift.protocol.TField TABLE_FIELD_DESC = new org.apache.thrift.protocol.TField("table", org.apache.thrift.protocol.TType.STRING, (short)1);
    private static final org.apache.thrift.protocol.TField REGION_ADDR_FIELD_DESC = new org.apache.thrift.protocol.TField("region_addr", org.apache.thrift.protocol.TType.STRING, (short)2);
    ...
    public @org.apache.thrift.annotation.Nullable String table; // required
    public @org.apache.thrift.annotation.Nullable String region_addr; // required

    /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
    public enum _Fields implements org.apache.thrift.TFieldIdEnum {
      TABLE((short)1, "table"),
      REGION_ADDR((short)2, "region_addr");
    ...
    static {
      ...
      tmpMap.put(_Fields.TABLE, new org.apache.thrift.meta_data.FieldMetaData("table", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
      tmpMap.put(_Fields.REGION_ADDR, new org.apache.thrift.meta_data.FieldMetaData("region_addr", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
      metaDataMap = java.util.Collections.unmodifiableMap(tmpMap);
    ...
    public recover_args(recover_args other) {
      ...
      if (other.isSetRegion_addr()) {
        this.region_addr = other.region_addr;
      }
    }
    ...
    public recover_args setRegion_addr(@org.apache.thrift.annotation.Nullable String region_addr) {
      this.region_addr = region_addr;
      return this;
    }

    public void unsetRegion_addr() {
      this.region_addr = null;
    }

    /** Returns true if field region_addr is set (has been assigned a value) and false otherwise */
    public boolean isSetRegion_addr() {
      return this.region_addr != null;
    }

    public void setRegion_addrIsSet(boolean value) {
      if (!value) {
        this.region_addr = null;
      }
    }
    ...
    public boolean equals(recover_args that) {
      ...
      boolean this_present_region_addr = true && this.isSetRegion_addr();
      boolean that_present_region_addr = true && that.isSetRegion_addr();
      if (this_present_region_addr || that_present_region_addr) {
        if (!(this_present_region_addr && that_present_region_addr))
          return false;
        if (!this.region_addr.equals(that.region_addr))
          return false;
      }
    ...
    public int hashCode() {
      ...
      hashCode = hashCode * 8191 + ((isSetRegion_addr()) ? 131071 : 524287);
      if (isSetRegion_addr())
        hashCode = hashCode * 8191 + region_addr.hashCode();
    ...
    public int compareTo(recover_args other) {
      ...
      lastComparison = Boolean.compare(isSetRegion_addr(), other.isSetRegion_addr());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetRegion_addr()) {
        lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.region_addr, other.region_addr);
        if (lastComparison != 0) {
          return lastComparison;
        }
      }
    ...
    public String toString() {
      ...
      first = false;
      if (!first) sb.append(", ");
      sb.append("region_addr:");
      if (this.region_addr == null) {
        sb.append("null");
      } else {
        sb.append(this.region_addr);
      }
      first = false;
      sb.append(")");
      return sb.toString();
    ...
    private static class recover_argsStandardScheme extends org.apache.thrift.scheme.StandardScheme<recover_args> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, recover_args struct) throws org.apache.thrift.TException {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            ...
            case 2: // REGION_ADDR
              if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
                struct.region_addr = iprot.readString();
                struct.setRegion_addrIsSet(true);
              } else { 
                org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
              }
              break;
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, recover_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.region_addr != null) {
          oprot.writeFieldBegin(REGION_ADDR_FIELD_DESC);
          oprot.writeString(struct.region_addr);
          oprot.writeFieldEnd();
        }
        oprot.writeFieldStop();
        oprot.writeStructEnd();
    ...
    private static class upgrade_argsStandardScheme extends org.apache.thrift.scheme.StandardScheme<upgrade_args> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.slave_addrs = new java.util.ArrayList<String>(_list8.size);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, upgrade_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.slave_addrs != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRING, struct.slave_addrs.size()));
            for (String _iter11 : struct.slave_addrs)
            {
    ...
    private static class upgrade_argsTupleScheme extends org.apache.thrift.scheme.TupleScheme<upgrade_args> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, upgrade_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetSlave_addrs()) {
          {
            oprot.writeI32(struct.slave_addrs.size());
            for (String _iter12 : struct.slave_addrs)
            {
        ...
        if (incoming.get(1)) {
          {
            ...
            struct.slave_addrs = new java.util.ArrayList<String>(_list13.size);
