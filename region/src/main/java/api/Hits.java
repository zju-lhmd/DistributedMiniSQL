...
public class Hits implements org.apache.thrift.TBase<Hits, Hits._Fields>, java.io.Serializable, Cloneable, Comparable<Hits> {
  ...
  public @org.apache.thrift.annotation.Nullable String schema; // required
  public @org.apache.thrift.annotation.Nullable java.util.List<String> records; // required
  ...
  public Hits(Hits other) {
    ...
    if (other.isSetRecords()) {
      java.util.List<String> __this__records = new java.util.ArrayList<String>(other.records);
  ...
  public Hits setSchema(@org.apache.thrift.annotation.Nullable String schema) {
    this.schema = schema;
    return this;
  }
  ...
  public void addToRecords(String elem) {
    if (this.records == null) {
      this.records = new java.util.ArrayList<String>();
    }
  ...
  public Hits setRecords(@org.apache.thrift.annotation.Nullable java.util.List<String> records) {
    this.records = records;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable Object value) {
    ...
    case RECORDS:
      if (value == null) {
        ...
        setRecords((java.util.List<String>)value);
      }
      break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.records = new java.util.ArrayList<String>(_list0.size);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Hits struct) throws org.apache.thrift.TException {
      ...
      if (struct.records != null) {
        oprot.writeFieldBegin(RECORDS_FIELD_DESC);
        {
          ...
          for (String _iter3 : struct.records)
          {
      ...
      if (struct.isSetRecords()) {
        {
          ...
          for (String _iter4 : struct.records)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.records = new java.util.ArrayList<String>(_list5.size);
