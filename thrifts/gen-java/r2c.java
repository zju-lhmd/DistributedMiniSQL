...
public class r2c {
  ...
  public interface Iface {
    ...
    public void writeResp(int state) throws org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void writeResp(int state, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void writeResp(int state) throws org.apache.thrift.TException
    {
      send_writeResp(state);
    }

    public void send_writeResp(int state) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void writeResp(int state, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      writeResp_call method_call = new writeResp_call(state, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public static class writeResp_call extends org.apache.thrift.async.TAsyncMethodCall<Void> {
      private int state;
      public writeResp_call(int state, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, true);
        this.state = state;
      }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class writeResp<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, writeResp_args, Void> {
      ...
      public void start(I iface, writeResp_args args, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws org.apache.thrift.TException {
        iface.writeResp(args.state,resultHandler);
      }
    }
  ...
  public static class readResp_args implements org.apache.thrift.TBase<readResp_args, readResp_args._Fields>, java.io.Serializable, Cloneable, Comparable<readResp_args>   {
    ...
    public java.lang.String toString() {
      java.lang.StringBuilder sb = new java.lang.StringBuilder("readResp_args(");
      boolean first = true;
  ...
  public static class writeResp_args implements org.apache.thrift.TBase<writeResp_args, writeResp_args._Fields>, java.io.Serializable, Cloneable, Comparable<writeResp_args>   {
    ...
    @Override
    public java.lang.String toString() {
      java.lang.StringBuilder sb = new java.lang.StringBuilder("writeResp_args(");
      boolean first = true;
